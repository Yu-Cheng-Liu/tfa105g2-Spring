...
public class CheckOrder extends HttpServlet {
	...
	public String Checkout(MemberOrderVO vo,Model model, HttpSession session,HttpServletRequest req, HttpServletResponse res) {
		...
		vo = memberorderservice.addOrder(vo);
