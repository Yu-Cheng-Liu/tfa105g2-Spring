                                ...
                                <ul>
                                    <li class="menu-item-has-children"><a href="#">祭祖商城</a>
                                        <ul class="sub-menu">
                                            ...
                                            <li>
                                            	<a href="${pageContext.request.contextPath}/AllProductServlet?action=selectAll">商品總攬</a>
                                            </li>
                                    ...
                                    <div class="page-sidebar-wrapper">
                                        ...
                                        <div class="single-sidebar-widget">
                                            ...
                                            <ul class="single-sidebar-widget__category-list">
                                                ...
                                                <li class="has-children"><a href="${pageContext.request.contextPath}/AllProductServlet?action=selectByType&prodTypeCode=${prodTypeVO.prodTypeCode}" class="active">${prodTypeVO.prodTypeDesc}
                                            ...
                                            <div class="col-12 col-lg-4 col-md-4 col-sm-6">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <!-- <a href="single-product.jsp"> -->
                                                        <a href="${pageContext.request.contextPath}/SingleProductServlet?prodNo=${prodVO.prodNo}">
                                                            <img width="600" height="800"
                                                                src="${pageContext.request.contextPath}/pictureServlet?prodNo=${prodVO.prodNo}&prodImg=1"
                                                                class="img-fluid" alt="">
                                                            <!-- <img width="600" height="800"
                                                                src="assets/img/products/1_1-600x800.webp"
                                                                class="img-fluid" alt=""> -->
                                                    ...
                                                    <div
                                                        ...
                                                        <h3
                                                            ...
                                                            <a href="${pageContext.request.contextPath}/SingleProductServlet?prodNo=${prodVO.prodNo}">${prodVO.prodName}</a>
