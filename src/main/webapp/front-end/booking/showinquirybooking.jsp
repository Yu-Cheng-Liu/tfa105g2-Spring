...
<body>
	...
	<c:forEach var="bookingVO" items="${select}">
	  ...
	  <table>
		...
		<tr id="dis">
			<td>
				<input name="bookingNo" type="text" class="bkno" value="${bookingVO.bookingNo}"readonly >		
			</td>
			<td>
			...
			<td>
				<input name="reserveDate" type="date" class="date" value="<fmt:formatDate value='${bookingVO.reserveDate}' pattern='yyyy-MM-dd'/>" disabled>
			</td>
			<td>
				<input name="orderNo"   type="text"class="orderno" value="${bookingVO.orderNo}" readonly>
			</td>
			<td>
				<input name="remark"  type="text" class="remark" value="${bookingVO.remark}" disabled>
			</td>
			<td>
