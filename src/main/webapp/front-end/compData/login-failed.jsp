									...
									<div class="header-settings-icon">
										...
										<div class="settings-menu-wrapper" id="settings-menu-wrapper">
											...
											<div class="single-settings-block">
												...
												<ul>
													<li><a
														href="<%=request.getContextPath()%>/front-end/compData/comp-login-register.html">廠商登入</a></li>
													<li><a
														href="<%=request.getContextPath()%>/front-end/compData/comp-login-register.html">廠商註冊</a></li>
												</ul>
											</div>
											<!-- <div class="single-settings-block">
											...
											<div class="row">
												<div class="col-md-12 col-12">
													<label>Company Account*</label> <input name="compAccount"
														...
														value="${username}"><span style="color: red;">${errors.username}</span>
							...
							<li class="menu-item-has-children"><a href="#">LANGUAGE:
								...
								<ul class="sub-menu">
									<li><a href="javascript:void(0)"><img width="16"
											height="11"
											src="<%=request.getContextPath()%>/assets/img/icons/en-gb.webp"
											alt=""> English</a></li>
									<li><a href="javascript:void(0)"><img width="16"
											height="11"
											src="<%=request.getContextPath()%>/assets/img/icons/de-de.webp"
											alt=""> Germany</a></li>
								</ul></li>
						</ul>
					</nav>
