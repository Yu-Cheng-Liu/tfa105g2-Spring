                                        ...
                                        <div class="login-form">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-12">
                                                    ...
                                                    <input name="compAccount" type="text" placeholder="Company Account*" value="${username}"><span style="color: red;">${errors.username}</span>
                                                    
                                                </div>
                                                <div class="col-12">
                                                    <label>Password*</label>
                                                    <input name="password" type="password" placeholder="Password*"><span style="color: red;">${errors.password}</span>
