                        ...
                        <div class="navigation-menu-wrapper">
                            <nav>
                                <ul>
                                    ...
                                    <li class="menu-item-has-children"><a href="shop-left-sidebar.html">客服小天使</a>
                        ...
                        <div class="page-content-wrapper">
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-xs-12 col-lg-6">
                                    <!-- Login Form s-->
                                    <form action="<%=request.getContextPath() %>/secure/login.controller" method="get">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-6 col-xs-12">
                                    <form action="<%=request.getContextPath() %>/secure/register.controller" method="POST">
                                        ...
                                        <div class="login-form">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-12 mb-20">
                                                    <label>Company Account*</label>
                                                    <input name="compAccount" type="text" placeholder="Company Account*" value="${compAccount}">
                                                    <span style="color: red;">${errors.compAccount}</span>
                                                </div>
                                                <div class="col-md-6 col-12 mb-20">
                                                    <label>Company Name</label>
                                                    <input name="compName" type="text" placeholder="Company Name"value="${compName}">
                                                ...
                                                <div class="chargePerson">
                                                    ...
                                                    <input name="chargePerson" type="text" placeholder="Charge Person" value="${chargePerson}">
                                                </div>
                                                <div class="compPhone">
                                                    <label>Company Phone</label>
                                                    <input name="compPhone" type="text" placeholder="Company Phone"value="${compPhone}">
                                                </div>
