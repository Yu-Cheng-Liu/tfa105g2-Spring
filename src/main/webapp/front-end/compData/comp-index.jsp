										...
										<div class="mini-cart" id="mini-cart">
											<div class="cart-items-wrapper ps-scroll">
												...
												<div class="single-cart-item">
													...
													<a
														href="${pageContext.request.contextPath}/CartServlet.controller?action=Delete&del=<%= index %>&prodNo=${prodNo}"
														class="remove-icon"><i class="ion-android-close"></i></a>
													...
													<div class="content">
														...
														<p class="product-title">
															<a href="single-product.jsp"><%=order.getProdName()%></a>
														</p>
														<p class="count">
															<span><%=order.getProdAmount()%> x </span> $
															<%=order.getProdPrice()%></p>
													</div>
												</div>
							...
							<div class="row">
								...
								<div class="col-lg-3 col-12">
									<div class="myaccount-tab-menu nav" role="tablist">
									    ...
									    <a href="#dashboad" ${attrs2}data-bs-toggle="tab"><i class="fa fa-dashboard"></i> 帳戶大廳</a>

										<a id="view-orders" href="#orders" ${attrs3} data-bs-toggle="tab">
										<i class="fa fa-cart-arrow-down"></i>訂單總覽</a> 
											
										<a href="#product-insert" ${attrs5} data-bs-toggle="tab">
										<i class="fa fa-cart-arrow-down"></i> 商品新增</a>
											
									    <a id="product-updateATag" href="#product-update" ${attrs6} data-bs-toggle="tab" onclick="getProdName();">
									    <i class="fa fa-cart-arrow-down"></i> 商品修改</a>
											
										<a id="product-launchAndDiscontinue" href="#product-management"	${attrs4} data-bs-toggle="tab">
								...
								<div class="col-lg-9 col-12">
									<div class="tab-content" id="myaccountContent">
										...
										<!-- Single Tab Content Start -->
										<!--  Order Details -->
										<div class="tab-pane fade ${classes2} " id="orders"
											role="tabpanel">
											<div class="myaccount-content">
												<h3>訂單總覽</h3>
										...
										<div class="tab-pane fade ${classes3} "
											id="product-management" role="tabpanel">
											<div class="myaccount-content">
												<h3>商品上架/下架</h3>
													...
													<table class="table table-bordered">
														...
														<c:forEach var="ProductVO" items="${prods}">
															...
															<form id="launchAndDiscontinueForm"
																...
																Method="post">
																<tbody>
																	<td><input type="checkbox" name="thisProduct"
...
<!-- 											</div> -->
											<div class="col-md-7">
											<label>商品編號*</label>
											<select id="ProdSel" name="prodName" class="form-select"
											...
											<label>商品類別<font style=color:red>*</font></label>
											<select id="findType1" style="width:130px" name="prodTypeCode">
											<option value="0">請選擇商品類別</option>
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <input type="file" id="p_file1" name="prodImg" />
                                                <div id="preview"><span class="text"></span></div>
                                                <br>
                                                <label>商品圖片-2</label>
                                                <input type="file" id="p_file12" name="prodImg" />
                                                <div id="preview2"><span class="text"></span></div>
                                                <br>
                                                <label>商品圖片-3</label>
                                                <input type="file" id="p_file13" name="prodImg" />
															...
															<div class="col-lg-7">
																...
																<div id="billing-form">
																	...
																	<div class="row justify-content-around">
																		...
																		<div class="col-md-7">
																			<label>商品類別<font style="color: red">*</font></label>
																			<select id="findType" style="width: 130px"
																				name="prodTypeCode">
																				<option value="0">請選擇商品類別</option>
																				<option value="1">水果</option>
																				<option value="2">鮮花</option>
																				<option value="3">祭祀用品</option>
																				<option value="4">其他</option>
																			</select> <font color="red"><c:out
																					value="${errorMsgs.prodTypeCode}" /></font>
																		</div>

																		<div class="col-md-7">
																			<label>商品名稱<font style="color: red">*</font></label>
																			<font color="red"><c:out
																					value="${errorMsgs['prodName']}" /></font> <input
																				type="text" placeholder="請輸入商品名稱" name="prodName"
																				value="${prodName}" />
																		</div>
																		...
																		<div class="col-md-7">
																			<label>商品價格<font style="color: red">*</font></label>
																			<font color="red"><c:out
																					value="${errorMsgs['prodPrice']}" /></font> <input
																				type="number" min="0" placeholder="請輸入商品價格"
																				name="prodPrice" value="${prodPrice}" />
																		</div>

																		<div class="col-md-7">
																			<label>商品說明</label> <input type="text"
																				placeholder="請輸入商品說明內容" name="prodDesc"
																				value="${prodDesc}" />
																		</div>
																		...
																		<div class="col-md-7">
																			<label>商品庫存量<font style="color: red">*</font></label>
																			<font color="red"><c:out
																					value="${errorMsgs['prodStock']}" /></font> <input
																				type="number" min="0" placeholder="請輸入數量"
																				name="prodStock" value="${prodStock}" />
																		</div>
																		<div class="col-md-7">
																			<label>商品圖片-1 <font style="color: red">*</font></label>
																			<font color="red"><c:out
																					value="${errorMsgs['prodImg1']}" /></font> <input
																				type="file" id="p_file" name="prodImg" />
																			<div id="preview">
																				<span class="text"></span>
																			</div>
																			<br> <label>商品圖片-2</label> <input type="file"
																				id="p_file2" name="prodImg" />
																			<div id="preview2">
																				<span class="text"></span>
																			</div>
																			<br> <label>商品圖片-3</label> <input type="file"
																				id="p_file3" name="prodImg" />
																			<div id="preview3">
																				<span class="text"></span>
																			</div>
																		</div>
														...
														<form
															...
															<div class="col-lg-6 col-12">
																公司名稱 <input id="compName" placeholder="公司名稱"
																	name="compName" value="${compName}" type="text"
																	disabled> <span style="color: red;">${errors.compName}</span>
																<br>
															</div>

															<div class="col-lg-6 col-12">
																公司負責人 <input id="chargePerson" placeholder="公司負責人"
																	name="chargePerson" value="${chargePerson}" type="text"
																	disabled> <span style="color: red;">${errors.chargePerson}</span>
															</div>

															<div class="col-12">
																電子郵件 <input id="email" placeholder="電子郵件" name="email"
																	value="${email}" type="email" disabled> <span
																	style="color: red;">${errors.email}</span>
															</div>

															<div class="col-12">
																公司地址 <input id="address" placeholder="公司地址"
																	name="address" value="${compAddress}" type="text"
																	disabled>
															</div>

															<div class="col-12">
																公司電話 <input id="compPhone" placeholder="公司電話"
																	name="compPhone" value="${compPhone}" type="text"
																	disabled>
															</div>

															<div class="col-12">
																公司統編 <input id="compAccount" placeholder="公司統編"
																	name="compAccount" value="${compAccount}" type="text"
																	disabled>
															</div>
														...
														<form
															...
															<div class="col-12">
																<input id="oldPass" placeholder="目前密碼" name="oldPass"
																	type="password"> <span style="color: red;">${errors.oldPass}</span>
															</div>

															<div class="col-lg-6 col-12">
																<input id="newPass" placeholder="新密碼" name="newPass"
																	type="password"> <span style="color: red;">${errors.newPass}</span>
															</div>

															<div class="col-lg-6 col-12">
																<input id="confirm" placeholder="確認密碼" name="confirm"
																	type="password"> <span style="color: red;">${errors.samePass}</span>
															</div>
				...
				<div class="chatbox__support">
					<div class="chatbox__header">
						<div class="chatbox__image--header">
							...
							<img src="https://github.com/mdo.png" alt="image" width="50"
