                                    ...
                                    <div class="header-settings-icon">
                                        ...
                                        <div class="settings-menu-wrapper" id="settings-menu-wrapper">
                                            ...
                                            <div class="single-settings-block">
                                                ...
                                                <ul>
                                                    <li><a href="<%=request.getContextPath() %>/secure/comp-login-register.html">廠商登入</a></li>
                                                    <li><a href="<%=request.getContextPath() %>/secure/comp-login-register.html">廠商註冊</a></li>
                                                </ul>
                                            </div>
                                           </div>
                                    </div>
            ...
            <div class="offcanvas-inner-content">
                ...
                <nav class="offcanvas-navigation">
                    <ul>
                        ...
                        <li class="menu-item-has-children"><a href="<%=request.getContextPath() %>/secure/comp-login-register.html">廠商登入</a>
                            <ul class="sub-menu">
                                <li><a href="login-register.html">Register</a></li>
                                <li><a href="login-register.html">Login</a></li>
