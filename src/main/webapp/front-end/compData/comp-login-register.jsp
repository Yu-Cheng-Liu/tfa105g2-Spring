										...
										<div class="login-form">
											...
											<div class="row">
												...
												<div class="col-sm-6 text-start text-sm-end">
													<a href="<%=request.getContextPath()%>/front-end/compData/forgetPassword.jsp" class="forget-pass-link">忘記密碼?</a>
												</div>
											...
											<div class="row">
												<div class="col-md-6 col-12 mb-20">
													<label>廠商統編*</label> <input name="compAccount"
														...
														<span style="color: red;">${errors.RcompAccount}</span>
												</div>
												<div class="col-md-6 col-12 mb-20">
													<label>廠商名稱*</label> <input name="compName" value="${RcompName}"
														type="text" placeholder="廠商名稱" >
														<span style="color: red;">${errors.RcompName}</span>
												</div>
